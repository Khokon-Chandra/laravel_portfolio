            ...
            <div class="scroll-sidebar">
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                    	...
                    	<li> <a href="{{url('/admin/services')}}" ><span> <i class="fas fa-globe"></i> </span><span class="hide-menu">Services</span></a></li>

                    	<li> <a href="{{url('/admin/courses')}}" ><span> <i class="fas fa-globe"></i> </span><span class="hide-menu">Courses</span></a></li>

                    	<li> <a href="{{url('/admin/projects')}}" ><span> <i class="fas fa-globe"></i> </span><span class="hide-menu">Projects</span></a></li>

                    	<li> <a href="{{url('/admin/blog')}}" ><span> <i class="fas fa-globe"></i> </span><span class="hide-menu">Post</span></a></li>

                    	<li> <a href="{{url('/admin/reviews')}}" ><span> <i class="fas fa-globe"></i> </span><span class="hide-menu">Reviews</span></a></li>
